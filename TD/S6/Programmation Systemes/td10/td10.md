...
1. Pour les fichiers localtime et timezone cette solution fonctionne uniquement lorsque l'on a le contrôle de la machine hôte. Par exemple cela n'est pas efficace lorsque l'on host sur le clo