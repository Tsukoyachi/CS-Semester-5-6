...
_start:
	...
	push	1		 ; Push Vrai si inférieur ou égal
	jmp	e1		 ; Va a la suite du code
e0 :	push	0		 ; Push Vrai si supérieur
e1 :	pop	eax
	call	iprintLF
	push	1
	push	15
...
e2 :	push	0		 ; Push Vrai si supérieur
e3 :	pop	eax
	call	iprintLF
	push	15
	push	15
	...
	pop	eax		 ; depile la permière operande dans eax
	cmp	eax, ebx		 ; Compare les opérandes
	jg	e4		 ; Jump si supérieur
	push	1		 ; Push Vrai si inférieur ou égal
	jmp	e5		 ; Va a la suite du code
e4 :	push	0		 ; Push Vrai si supérieur
e5 :	pop	eax
	call	iprintLF
